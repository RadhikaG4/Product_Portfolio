...
- Real copy is in for Work windows, Lab, hero intro and folder.
...
- `src/data/projects.js`: project names, dates, each Work window (`window`: lede, tags, overview, role, highlights, tools, results, learnings, hero, gallery of [image, caption]), Lab rows (`text`), contact details.
